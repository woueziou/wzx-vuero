    ...
    <div class="inner" data-simplebar>
      <ul>
        <VCollapseLinks v-model:open="openSubsidebarLinks" collapse-id="personal">
          ...
          <RouterLink :to="{ name: 'sidebar-dashboards-personal-2' }" class="is-submenu">
            <i aria-hidden="true" class="lnil lnil-pie-chart"></i>
            <span>Personal V2</span>
          </RouterLink>
          <RouterLink :to="{ name: 'sidebar-dashboards-personal-3' }" class="is-submenu">
        ...
        <VCollapseLinks v-model:open="openSubsidebarLinks" collapse-id="banking">
          ...
          <RouterLink :to="{ name: 'sidebar-dashboards-banking-1' }" class="is-submenu">
            <i aria-hidden="true" class="lnil lnil-bank"></i>
            <span>Banking V1</span>
          </RouterLink>
          <RouterLink :to="{ name: 'sidebar-dashboards-banking-2' }" class="is-submenu">
            <i aria-hidden="true" class="lnil lnil-bank"></i>
            <span>Banking V2</span>
          </RouterLink>
          <RouterLink :to="{ name: 'sidebar-dashboards-banking-3' }" class="is-submenu">
            <i aria-hidden="true" class="lnil lnil-bank"></i>
        ...
        <VCollapseLinks v-model:open="openSubsidebarLinks" collapse-id="lifestyle">
          ...
          <RouterLink :to="{ name: 'sidebar-dashboards-influencer' }" class="is-submenu">
        ...
        <VCollapseLinks v-model:open="openSubsidebarLinks" collapse-id="ecommerce">
          ...
          <RouterLink :to="{ name: 'sidebar-dashboards-ecommerce-1' }" class="is-submenu">
        ...
        <VCollapseLinks v-model:open="openSubsidebarLinks" collapse-id="charts">
          ...
          <RouterLink :to="{ name: 'sidebar-dashboards-charts-apex' }" class="is-submenu">
